...
function PlaylistMusic(){
    return(
        <main className="text-white relative bg-[#121212]">
            <div style={{backgroundColor: "rgb(144, 168, 192)"}} className="bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,.5)] h-[340px] absolute -top-[110px] w-full pb-6 px-8 flex items-end">
